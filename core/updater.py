...
def _launch_windows_update_script(
    ...
    bat_lines = [
        ...
        "",
        'if exist "%BUNDLE_DIR%\\_internal_backup" rmdir /S /Q "%BUNDLE_DIR%\\_internal_backup"',
        'ren "%BUNDLE_DIR%\\_internal" "_internal_backup"',
        "if errorlevel 1 goto :cleanup",
        "",
        'ren "%BUNDLE_DIR%\\_internal_new" "_internal"',
